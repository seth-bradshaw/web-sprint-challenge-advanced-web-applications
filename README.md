...
To verify that a user is authorized to see private content
2. What steps can you take in your web apps to keep your data secure?
There are numerous ways to accomplish this. If you want to hide information from users who aren't logged in you want to have a private route
